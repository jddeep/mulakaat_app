...
class LogsignIn extends StatelessWidget {
  ...
  final Shader linearGradient = LinearGradient(colors: <Color>[Colors.white,
  Colors.orange, Colors.green]).createShader(Rect.fromLTWH(0.0, 0.0, 200.0, 150.0));
  @override
              ...
              child:Column(
                ...
                children: <Widget>[
                  Column(
                    ...
                    children: <Widget>[
                      Text(
                    FlutterI18n.translate(context, 'Mulakaat'),
                    style: TextStyle(
