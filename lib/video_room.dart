...
const APP_ID = "4b13657c18cc462ea25d44dc6d14584f";
...
class VideoRoom extends StatefulWidget {
  ...
  const VideoRoom({Key key, this.groupId, this.pageNavigatorState})
      : super(key: key);
...
class VideoRoomState extends State<VideoRoom> {
  ...
  static const platform = const MethodChannel("screen_share");
  ...
  _shareScreen() async {
    // String batteryLevel;
    try {
      await platform.invokeMethod("shareScreen");
    } on PlatformException catch (e) {
      print("Failed to share screen: '${e.message}'.");
    }
  }
